...
class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        switch (viewType) {
            ...
            case NATIVE_CONTENT_AD_VIEW_TYPE:
                View nativeContentLayoutView = LayoutInflater.from(
                        viewGroup.getContext()).inflate(R.layout.content_ad_item,
                        viewGroup, false);
     ...
     * The onBindViewHolder()method is called by RecyclerView to display the data at the
     * specified position.
     */
    @Override
